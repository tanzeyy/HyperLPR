...
class Recognizer:
    chars = ["京", "沪", "津", "渝", "冀", "晋", "蒙", "辽", "吉", "黑", "苏", "浙", "皖", "闽", "赣", "鲁", "豫", "鄂", "湘", "粤", 
...
if __name__ == "__main__":
    lpr = Recognizer("./sources/model/ocr_plate_all_gru.h5")
    image = cv2.imread("./test_images/test_chars.jpg")
    result = lpr.recognize_one(image)
    print(result)